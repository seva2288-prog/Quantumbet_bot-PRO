...
# ============================================================
# ФАЙЛ 3: ОБНОВЛЕННАЯ ФУНКЦИЯ find_top_matches (20 СТАВОК)
# ============================================================
...
def find_top_matches(matches):
    ...
    for match in matches:
        # Проверяем лимит ставок за запуск
...
def webhook():
    ...
    try:
        ...
        if 'message' in data:
            ...
            # ============================================================
            # ФАЙЛ 4: ОБНОВЛЕННЫЙ ОБРАБОТЧИК /update (20 СТАВОК)
            # ============================================================
                ...
                if search_running:
                    ...
                    if matches:
                        ...
                        if top_matches:
                            # Отправляем только топ-5 матчей с кнопками
