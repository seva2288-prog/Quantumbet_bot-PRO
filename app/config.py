...
class Config:
    ...
    # Минимальный EV для ТМ 2.5 (в процентах)
    MIN_TM25_EV = 25  # 25%
    
    # Минимальная вероятность для ТМ 2.5 (в процентах)
    MIN_TM25_PROB = 60  # 60%
    
    # Диапазон XG для ТМ 2.5
    TM25_XG_MIN = 1.2
    TM25_XG_MAX = 2.8
    ...
    # Минимальный EV для ТМ 2.5 в топ-лигах (в процентах)
    TM25_TOP_LEAGUE_EV = 35  # 35%
